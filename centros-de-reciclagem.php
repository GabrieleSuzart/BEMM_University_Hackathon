...
<div class="geral_cima">
	<div class="geral_baixo">
    	<div class="content">
        	<h1>ENCONTRE UM CENTRO DE RECICLAGEM</h1>
		...
		$sql=mysql_query("select * from organizacao where tipo='Centro de Reciclagem'") or die ("Problemas");
		$cont=1;
		...
		while($linha=mysql_fetch_array($sql)){
			...
			if($cont%2!=0){
				echo"
					<li>
						<h2>$nome</h2>
						<p>$logadouro, $numero, $cep <br> $cidade - $estado <br> $telefone | $celular</p>
					</li>
				";
			}else{
				echo"
